...
<script>
  ...
  gtag('config', 'UA-117856180-1');
	...
	<meta name="author" content="Mainteam">
		...
		<meta property="og:url" content="http://www.concurvas.com">
		<meta property="og:image" content="http://concurvas.com/wp-content/themes/mainteam_Concurvas/imagenes/iconos/LOGO.png"> 
	...
	<!-------------------FUENTES---------------->
    	...
    	<!-------------------FUENTES---------------->
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/csscool/main_blog.css"> <!-- CSS reset -->
  	<!-------------------BOOTSTRAP---------------->	
...
<script>
  ...
  fbq('init', '812304638905900');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=812304638905900&ev=PageView&noscript=1"
/></noscript>
...
s.parentNode.insertBefore(t,s)}(window, document,'script',
'https://connect.facebook.net/en_US/fbevents.js');
fbq('init', '349719096623623');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=349719096623623&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
</head>
<body>
