jQuery(document).ready(function($){
	...
	function addProduct(color,talla,precio,nombre,productId) {
		...
		var productAdded = $('<li class="product"><div class="product-image"><a href="#0"><img src="'+url+'" alt="placeholder"></a></div><div class="product-details"><h3 class="letra26pt-pc letra3pt-mv tipografiaHtres tregular"><a href="#0">'+ nombre +'</a></h3><span class="price tipografiaHtres">'+ precio +'</span><div class="actions"><a href="#0" class="delete-item tipografiaHtres">Borrar</a><div class="quantity tipografiaHtres"><label for="cd-product-'+ productId +'">Cant</label><span class="select"><select id="cd-product-'+ productId +'" name="quantity"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option></select></span></div></div></div></li>');
