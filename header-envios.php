...
<!-- TIKTOK -->
	...
	<style type="text/css">
		/*------------------------BOTON-----------------------*/		
		.botonmodal{border:none;line-height:20px;padding:0px 0 0 0;text-transform:none;letter-spacing:0;width:30%;transition:.4s;-webkit-transition:.4s;margin:50px 35%;display:table;}
		...
		.valorl{
    		...
    		color: gray;
    		font-weight: 400;}
		.input-group-prepend{width: 35% !important;}
		</style>	
</script>
<!-- Facebook Pixel Code --
<script>
  ...
  fbq('init', '560471145134917');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=560471145134917&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
</head>
<body>
<?php get_template_part('cabecera'); ?>
	</div>	